    ...
    <div className="max-w-[1200px] w-full mx-auto" id="content-id">
      <div className="w-full bg-white lg:px-[70px] lg:pb-[18px] px-5 py-4">
              ...
              <div className="py-[11px] text-black">
                <h1 className="flex flex-col justify-center lg:block">
                  ...
                  <span className="lg:text-[24px] lg:leading-[30px] text-[20px] leading-[25px] pl-1 lg:text-left text-center">
                    {displayValue} {t("Your-offer.offer-option1")}{" "}
                    {displayValue}
                    ...
                    return (
                      <div className="flex w-full" key={index}>
                        ...
                        <div className="flex max-w-[calc(100%_-_225px)] w-full">
                          ...
                          >
                            {tempData[index].neosPanelProvider || "-"}
                          </div>
                          <div
                          ...
                          >
                            {tempData[index].neosPanelKeepProvider || "-"}
                          </div>
                          <div
                          ...
                          >
                            {tempData[index].rooftopPanelKeepProvider || "-"}
                          </div>
                          <div
        ...
        <div className="flex lg:items-center lg:justify-end lg:gap-[196px] lg:flex-row flex-col gap-8 items-center justify-center lg:mb-0 mb-[22px]">
          ...
          <NeosButton
            className={
              "px-[24px] lg:py-[14px] py-[17px] text-sm leading-4 font-semibold lg:!mr-[36px] w-auto"
            }
            category="colored"
